                          ...
                          ApeGlobalStore_t* globalstore)
{
    ...
    comp->modules = strdict_make(ctx, (ApeDataCallback_t)ape_module_copy, (ApeDataCallback_t)ape_module_destroy);
    if(!comp->modules)
    {
        goto err;
    }
...
static bool ape_compiler_compileexpression(ApeCompiler_t* comp, ApeExpression_t* expr)
{
    ...
    switch(expr->type)
    {
        ...
        case EXPRESSION_FUNCTION_LITERAL:
        {
            ...
            if(!compres)
            {
                ptrarray_destroywithitems(freesymbols, (ApeDataCallback_t)ape_symbol_destroy);
                goto error;
            }
