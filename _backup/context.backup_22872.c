...
void context_setdefaultconfig(ApeContext_t* ctx)
{
    ...
    context_setfileread(ctx, ape_util_default_readfile, ctx);
    context_setfilewrite(ctx, ape_util_default_writefile, ctx);
    context_setstdoutwrite(ctx, ape_util_default_stdoutwrite, ctx);
}
