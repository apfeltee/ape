...
ApeArray_t* array_makecapacity(ApeAllocator_t* alloc, unsigned int capacity, size_t element_size)
{
    bool ok;
    ApeArray_t* arr;
...
bool array_removeat(ApeArray_t* arr, unsigned int ix)
{
...
bool array_initcapacity(ApeArray_t* arr, ApeAllocator_t* alloc, unsigned int capacity, size_t element_size)
{
    arr->alloc = alloc;
    if(capacity > 0)
    {
...
ApePtrArray_t* ptrarray_makecapacity(ApeAllocator_t* alloc, unsigned int capacity)
{
    bool ok;
...
bool ptrarray_removeat(ApePtrArray_t* arr, unsigned int ix)
{
