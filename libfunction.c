...
ApeObject_t
object_make_function(ApeGCMemory_t* mem, const char* name, ApeCompilationResult_t* comp_res, bool owns_data, ApeInt_t num_locals, ApeInt_t num_args, ApeSize_t free_vals_count)
{
